...
colors = [
    ...
    "Gray", "Turquoise", "Magenta", "Lavender", "Indigo", "Teal", "Olive", "Maroon", "Navy", "Coral",
    "Mint", "Beige", "Plum", "Chartreuse", "Crimson", "Periwinkle", "Mauve", "Aquamarine", "Burgundy", "Tan",
    "Salmon", "Gold", "Silver", "Bronze", "Peach", "Lilac", "Ivory", "Emerald", "Ruby", "Sapphire",
    "Amber", "Charcoal", "Slate", "Mustard", "Khaki", "Fuchsia", "Lime", "Sky", "Forest", "Rose",
    "Cerulean", "Rust", "Cobalt", "Sienna", "Sage", "Mahogany", "Taupe", "Ochre", "Azure", "Scarlet",
    "Sangria", "Terracotta", "Dandelion", "Pumpkin", "Apricot", "Sepia", "Ash", "Ebony", "Pearl", "Cream",
    "Eggplant", "Mulberry", "Pistachio", "Canary", "Orchid", "Champagne", "Chestnut", "Glacier", "Midnight", "Denim",
    "Tangerine", "Moss", "Marigold", "Gunmetal", "Honeydew", "Mango", "Pewter", "Cornflower", "Olive", "Cayenne",
    "Wisteria", "Bisque", "Flax", "Brass", "Puce", "Vermilion", "Celadon", "Saffron", "Periwinkle"
]
