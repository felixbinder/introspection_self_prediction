...
def plot_heatmap_with_ci_flipped(data, value_col: str = "meta_predicted_correctly",
    ...
    for i in range(len(heatmap_data.index)):
        for j in range(len(heatmap_data.columns)):
            ...
            ax.text(j + 0.5, i + 0.75, f"({lower_bound:.1f} - {upper_bound:.1f})", color='white', ha='center', va='center', fontsize=10)
