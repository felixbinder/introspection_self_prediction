...
combined_df['object_model_mapped'] = combined_df['object_model'].map(object_model_mapping).fillna(combined_df['object_model'])
...
desired_order = [
    "GPT-4o",
    "Baseline Trained GPT-4o",
    "Self-Prediction Trained GPT-4o"
]
...
accuracy_df['object_model_mapped'] = pd.Categorical(
    accuracy_df['object_model_mapped'],
