...
data = read_jsonl_file_into_basemodel("evals/datasets/val_survival_instinct.jsonl", Data) + read_jsonl_file_into_basemodel("evals/datasets/val_myopic_reward.jsonl", Data)
finetune = data.map(
