...
def gpt4o_july_5():
    ...
    meta_model = "ft:gpt-4o-mini-2024-07-18:dcevals-kokotajlo::9qNoGWwF"  # shifted 1000, with mix
    ...
    df = calculate_evidence_0(
        ...
        micro_average=True,
        exclude_noncompliant=True,
        before_label="1) Gpt4mini predicting Gpt4mini",
        after_label="2) Gpt4mini_ft predicting Gpt4mini_ft",
    )
